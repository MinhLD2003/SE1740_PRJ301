    <%-- 
        Document   : homepage
        Created on : Jun 3, 2023, 3:48:30 PM
        Author     : Admin
    --%>
                    ...
                    <div class="row features-inner">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="single-features">
                                <div class="f-icon">
                                    <img src="${pageContext.request.contextPath}/images/features/f-icon1.png" alt="">
                                </div>
                                <h6>Free Delivery</h6>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="single-features">
                                <div class="f-icon">
                                    <img src="${pageContext.request.contextPath}/images/features/f-icon2.png" alt="">
                                </div>
                                <h6>Return Policy</h6>
                                <p>Free Shipping on all order</p>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="single-features">
                                <div class="f-icon">
                                    <img src="${pageContext.request.contextPath}/images/features/f-icon3.png" alt="">
                                </div>
                                <h6>24/7 Support</h6>
                                <p>Free Shipping on all order</p>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="single-features">
                                <div class="f-icon">
                                    <img src="${pageContext.request.contextPath}/images/features/f-icon4.png" alt="">
                                </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8">
                                    <div class="single-deal">
                                        ...
                                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/images/category/c1.jpg" alt="">
                                        <a href="${pageContext.request.contextPath}/images/category/c1.jpg" class="img-pop-up" target="_blank">
                                            <div class="deal-details">
                                                <h6 class="deal-title">Sneaker for Couple</h6>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <div class="single-deal">
                                        <div class="overlay"></div>
                                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/images/category/c2.jpg" alt="">
                                        <a href="${pageContext.request.contextPath}/images/category/c2.jpg" class="img-pop-up" target="_blank">
                                            <div class="deal-details">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="single-deal">
                                        <div class="overlay"></div>
                                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/images/category/c3.jpg" alt="">
                                        <a href="${pageContext.request.contextPath}/images/category/c3.jpg" class="img-pop-up" target="_blank">
                                            <div class="deal-details">
                                ...
                                <div class="col-lg-8 col-md-8">
                                    <div class="single-deal">
                                        <div class="overlay"></div>
                                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/images/category/c4.jpg" alt="">
                                        <a href="${pageContext.request.contextPath}/images/category/c4.jpg" class="img-pop-up" target="_blank">
                                            <div class="deal-details">
                                                <h6 class="deal-title">Sneaker for Kids</h6>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100" src="${pageContext.request.contextPath}/images/category/c5.jpg" alt="">
                                <a href="${pageContext.request.contextPath}/images/category/c5.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 text-center">
                                <div class="section-title">
                                    ...
                                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, culpa. Eaque
                                        sapiente ea provident voluptatem obcaecati nulla at distinctio quaerat?</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
