                                    ...
                                    <c:forEach var="product" items="${productList}">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="single-product">
                                                <a class="product_link" href="${pageContext.request.contextPath}/productcontroller?action=singleproduct&product_variant=${product.productCode}">
                                                ...
                                                <div class="product-details">
                                                    ...
                                                    <div class="prd-bottom">
                                                        <a href="${pageContext.request.contextPath}/cart?action=add_item&product_variant=${product.productCode}" class="social-info">
